(function() {
  ...
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.s3_folder = 'default';
    ...
    S3Upload.prototype.executeOnSignedUrl = function(file, callback) {
      ...
      this_s3upload = this;
      xhr = new XMLHttpRequest();
      xhr.open('GET', this.s3_sign_put_url + '?s3_folder='+ this.s3_folder +'&s3_object_type=' + file.type + '&s3_object_name=' + this.s3_object_name, true);
